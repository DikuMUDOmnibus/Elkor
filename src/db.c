...
sh_int          gsn_totalblind;  /* Monk Power - Loki */

sh_int  		gsn_godbless;  /* Monk Power - Loki */

sh_int  		gsn_drowbless;  /* DrowBless - Elkor */
...

{
    ...
    *obj		= obj_zero;
    ...
    else if (obj->pIndexData->vnum >= 29600 && obj->pIndexData->vnum <= 29750)
