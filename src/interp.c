...
#include <unistd.h> /* Added for disable commands - Loki */
...

{
    ...
    * { "donate",	        do_donate,	POS_SITTING,	 0,  LOG_NORMAL	},*/
    ...
    { "ssc",		do_ssc,		POS_DEAD,	12,  LOG_NEVER  },
...
*/
 ...
 /*   { "auction",	do_auction,	POS_SLEEPING,	 0,  LOG_NORMAL},*/
   ...
   /* { "showartifacts",	do_show_artifacts,POS_SITTING,	 1,  LOG_NORMAL	},  */
	...
	{ "cainform",	do_cainform,	POS_SITTING,	 3,  LOG_NORMAL	},

	{ "cainsummon",	do_cainsummon,	POS_SITTING,	 3,  LOG_NORMAL	},

   /* { "claninfo",	do_show_clan_info,POS_SITTING,	 1,  LOG_NORMAL	},  */

    { "claw",		do_claw,	POS_SITTING,	 3,  LOG_NORMAL	},

	{ "shaman",		do_shaman,	POS_SITTING,	 3,  LOG_NORMAL	},
    ...
    { "halo",		do_horns,	POS_STANDING,	 3,  LOG_NORMAL	},

	{ "holyfeet",		do_hooves,	POS_STANDING,	 3,  LOG_NORMAL	},

	{ "angelmask",	do_demmask,	POS_STANDING,	 3,  LOG_NORMAL	},

	{ "sweep",		do_tail,	POS_STANDING,	 3,  LOG_NORMAL	},
    
	{ "whiteangelarmour", do_blackdemonarmour,	POS_STANDING,	 3,  LOG_NORMAL	},
	
	{ "blueangelarmour",	do_reddemonarmour,	POS_STANDING,	 3,  LOG_NORMAL	},
...
/* Drow Stuff */
    ...
    { "drows",		do_drows,	    POS_SITTING,    2, LOG_NORMAL },

    { "drowfire",	do_drowfire,	POS_FIGHTING,  3, LOG_NORMAL },

	{ "drowbless",	do_drowbless,	POS_FIGHTING,  3, LOG_NORMAL },

    { "darkness",	do_darkness,    POS_STANDING, 3, LOG_NORMAL },	

    { "drowshield",	do_shield,	    POS_STANDING, 3, LOG_NORMAL },

    { "drowcreate",	do_drowcreate,	POS_STANDING, 3, LOG_NORMAL },

    { "drowsight",	do_drowsight,   POS_STANDING, 3, LOG_NORMAL },

    { "sign",		do_sign,	    POS_MEDITATING, 3, LOG_NORMAL },

    { "heal",		do_heal,	    POS_FIGHTING, 3, LOG_NORMAL	},

    { "chaosblast",	do_chaosblast,	POS_FIGHTING, 3, LOG_NORMAL },

    { "offering",	do_offering,	POS_FIGHTING, 3, LOG_NORMAL },



/* Vic commands */

	{ "relevel",	do_relevel,	    POS_DEAD,     0, LOG_NORMAL },

	{ "punish",     do_punish,          POS_DEAD,    12, LOG_NORMAL },

	{ "autostance",	do_autostance,	POS_STANDING, 0, LOG_NORMAL },

	{ "stances",	do_stances,	    POS_STANDING, 0, LOG_NORMAL },

	{ "weapons",	do_weapons,	    POS_STANDING, 0, LOG_NORMAL },

	{ "donate",	    do_donate,	    POS_STANDING, 0, LOG_NORMAL },

	{ "version",	do_version,	    POS_SLEEPING, 0, LOG_NORMAL },

	{ "shift",	    do_shift,	    POS_STANDING, 3, LOG_NORMAL },

    { "outcast",	do_outcast,	    POS_SLEEPING, 3, LOG_NORMAL },

    { "level",	    do_level, 	    POS_DEAD,     0, LOG_NEVER  },  

    { "klaive",	    do_klaive,	    POS_STANDING, 3, LOG_NORMAL },

	{ "moonarmour",	do_moonarmour,	    POS_STANDING, 3, LOG_NORMAL },

    { "dreadgaze",	do_dreadgaze,	POS_STANDING, 3, LOG_NORMAL },
	...
	{ "bomuzite",	do_bomuzite,	POS_SITTING,  3,  LOG_NORMAL	},

	{ "discipline",	do_discipline,	POS_STANDING, 3,  LOG_NORMAL	},

	{ "kakusu",		do_kakusu,	    POS_STANDING, 3,  LOG_NORMAL	},

    { "kanzuite",	do_kanzuite,	POS_DEAD,	  3,  LOG_NORMAL	},

    { "michi",		do_michi,	    POS_FIGHTING, 3,  LOG_NORMAL	},

    { "voracon",		do_voracon,	    POS_FIGHTING, 3,  LOG_NORMAL	},
	
	{ "mienaku",	do_mienaku,	    POS_FIGHTING, 3,  LOG_NORMAL	},

    { "nclan",		do_nclan,	    POS_DEAD,	  3,  LOG_NORMAL	},

    { "principles",	do_principles,	POS_SITTING,  3,  LOG_NORMAL	},

    { "ninjaarmor",	do_ninjaarmor,	POS_STANDING, 3,  LOG_NORMAL	},

    { "mikt",	    do_mikt,	    POS_DEAD,     3,  LOG_NORMAL	},

    { "clantalk",	do_clantalk,	POS_DEAD,     0,  LOG_NORMAL	},

    { "ct",	   	    do_clantalk,	POS_DEAD,     0,  LOG_NORMAL	},

   	{ "clans",	   	do_clans,	    POS_DEAD,     0,  LOG_NORMAL	},    

    

	{ "monk",        do_monk,	POS_DEAD,	      0,  LOG_NORMAL	},

	{ "guide",		do_guide,	POS_STANDING,	  3,  LOG_NORMAL	},

    { "mantra",	    do_mantra,	POS_SITTING,	  3,  LOG_NORMAL	},

    { "eyesofgod",    do_eyesofgod,  	POS_SITTING,	 3,  LOG_NORMAL	},

  	{ "steelshield", do_steelshield,	POS_STANDING,	 3,  LOG_NORMAL	},

    { "almightyfavour",	do_almightyfavour,	POS_FIGHTING,3, LOG_NORMAL },

    { "darkblaze",	do_darkblaze,	POS_STANDING,	     3,  LOG_NORMAL	},

	{ "mclan",		do_mclan,	POS_DEAD,	             0,  LOG_NORMAL	}, 

	{ "target",		do_target,	POS_SITTING,	         3,  LOG_NORMAL	},
...
/* Vic God Commands */
	...
	{ "class",	    do_class,	    POS_DEAD,    10, LOG_ALWAYS },

    { "clanname",	do_clanname,	POS_DEAD,     9, LOG_ALWAYS },

    { "generation",	do_generation,	POS_DEAD,     9, LOG_ALWAYS },	

	{ "disable",	do_disable,	POS_DEAD,	     10,  LOG_ALWAYS },
    ...
    { "undeny",		do_undeny,	POS_DEAD,	 0,  LOG_ALWAYS },
   ...
   /* { "fileupdate",	do_fileupdate,	POS_DEAD,	12,  LOG_ALWAYS	},*/
    ...
    { "pload",		do_pload,	POS_DEAD,	11,  LOG_ALWAYS	},
