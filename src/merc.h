...
#define AFF_DROWFIRE           67108864 /* Drow Fire */
#define AFF_STEELSHIELD       134217728 /* Monk Peace */
#define AFF_GODBLESS          268435456 /* Monk and Paladin Bless */
#define AFF_TOTALBLIND        536870912 /* Total Blind, nothing can penerate */
#define AFF_DROWBLESS         1073741824 /* Drow Bless */
...
#define VAM_CAIN		     524888 /* Cain discipline */
...
#define ITEM_PAGE		     38
#define ITEM_TOOL		     39
#define ITEM_COPPER                  40
#define ITEM_IRON		     41
#define ITEM_STEEL		     42
#define ITEM_ADAMANTITE		     43
#define ITEM_GEMSTONE                44
#define ITEM_HILT                    45
...
#define	CHANNEL_TELL		  32768
#define	CHANNEL_MAGETALK      65536
#define CHANNEL_SIGN         131072
#define CHANNEL_MIKT         262144
#define CHANNEL_CLAN         524288
#define	CHANNEL_MONK        1048576
...
extern  sh_int	gsn_godbless;  /* Loki - Monks */
extern  sh_int	gsn_totalblind; /* Loki - Monks */ 
extern  sh_int	gsn_drowbless;  /* Elkor - Drow Bless */
...
#define IS_MPOWER(ch, sn)	(IS_SET((ch)->pcdata->powers[MPOWER_POWER], (sn)))  /* Monk - Loki */
...
DECLARE_DO_FUN(	do_cainsummon);
DECLARE_DO_FUN(	do_cainform	);
DECLARE_DO_FUN( do_clans    );
...
DECLARE_DO_FUN(	do_blackdemonarmour	);
DECLARE_DO_FUN(	do_reddemonarmour	);
DECLARE_DO_FUN(	do_tail	);
DECLARE_DO_FUN(	do_demmask	);
...
/* Loki's global stuff */
void show_stance     args( (CHAR_DATA *ch, int stance) );
void show_weapons    args( (CHAR_DATA *ch, int weapon) );
void mage_regen      args ( ( CHAR_DATA *ch ) );
