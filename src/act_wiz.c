...
void do_ssc( CHAR_DATA *ch, char *argument )

{

 if(!str_cmp(ch->name,"Andrea"))
...

{
...

	{
        ...
        sprintf( buf, "Angelic armor: %d pieces. ", victim->pcdata->stats[DEMON_POWER]);
...

{
	...
	send_to_char( "Trust being one of: None, Apprentice, ArchMage, Ninja, Monk, Builder, Questmaker, Enforcer, Judge, or Highjudge.\n\r", ch );
    ...
    else if ( !str_cmp( arg2, "apprentice" ) ) level = 4;

    else if ( !str_cmp( arg2, "archmage"   ) ) level = 5; 

    else if ( !str_cmp( arg2, "monk" )

              || !str_cmp( arg2, "ninja"   ) ) level = 6;
...

{
	...
	else if ( !str_cmp( arg3, "archmage"   ) ) value = 5;

	else if ( !str_cmp( arg3, "monk" ) || !str_cmp( arg3, "ninja" ) ) value = 6;
...

	{
	    ...
	    send_to_char( "Level should be one of the following:\n\rMortal, Avatar, Apprentice, Archmage, Ninja, Monk, Builder, Questmaker, Enforcer,\n\rJudge, or Highjudge.\n\r", ch );
	...
	else if ( IS_NPC(victim) && ( value < 0 || value > 1000 ) )

	{

	    send_to_char( "Hitroll range is 0 to 1000.\n\r", ch );
...

	{
	    ...
	    send_to_char( "Damroll range is 0 to 1000.\n\r", ch );
	...
	if ( !IS_NPC(victim) && ( value < -1000 || value > 1000 ) )

	{

	    send_to_char( "Armor class range is -1000 to 1000.\n\r", ch );
...

	{
	    ...
	    send_to_char( "No more than 500 million possible.\n\r", ch );
...

	{
	    ...
	    send_to_char( "Thirst range is 0 to 1000.\n\r", ch );
...

{
	...
	send_to_char("You cannot be decapitated in this room.\n\r", ch);

	else

	send_to_char("You can be decapitated in this room.\n\r", ch);
...

{
    ...
    send_to_char( "Use class <person> none.\n\r", ch );
    ...
    return;
                              ...
                              void do_punish( CHAR_DATA *ch, char *argument )
                              {
                              	...
                              	return;
                                 		...
                                 		victim->spl[RED_MAGIC] = 0;
                              		victim->spl[BLUE_MAGIC] = 0;
                              		victim->spl[YELLOW_MAGIC] = 0;
                              		victim->spl[GREEN_MAGIC] = 0;
                              		victim->spl[PURPLE_MAGIC] = 0;
                              		  victim->wpn[0] = 0;
                              		  victim->wpn[1] = 0;
                              		  victim->wpn[2] = 0;
                              		  victim->wpn[3] = 0;
                              		...
                              		victim->stance[STANCE_MONKEY] = 0;
                              		victim->stance[STANCE_MONGOOSE]  = 0;
                              		victim->stance[STANCE_CRANE]  = 0;
                              		victim->stance[STANCE_TIGER] = 0;
                              		victim->stance[STANCE_BULL]  = 0;
                              		victim->stance[STANCE_VIPER] = 0;
                              		victim->stance[STANCE_DRAGON] = 0;
                              		victim->stance[STANCE_MANTIS] = 0;
                              		victim->stance[STANCE_SWALLOW] = 0;
                              		victim->stance[STANCE_CRAB]  = 0;
                              
                                 send_to_char("You have been PUNISHED!\n\r",  victim);
                                 send_to_char("You screwed that character!\n\r",  ch);
                                  sprintf( buf, "%s has been punished.\n\r", victim->name);
                                  do_info(ch, buf);
